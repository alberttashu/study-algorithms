    ...
    var objects = (function () {
        ...
        var Disk = sprites.extend(sprites.Sprite, {
                ...
                this.release = function () {
                    ...
                    if (draggingEnabled) {
                        ...
                        timeline.addEvent(
                            frame - 3,
                            1,
                            this.moveToPegPosition.bind(this)
                        );
                    }
                };
            ...
            moveToPegPosition: function () {
                ...
                this.y =
                    this.peg.y + this.peg.h - (this.h + 0.1) * (disksUnder + 1);
            },
        ...
        for (var i = numberOfDisks - 1; i >= 0; i--) {
            ...
            var pegNum = parseInt(
                Program.settings()["disk" + diskNum] || 0,
                10
            );
        ...
        objects.timeline.addEvent(
            ...
            function () {
                ...
                workingDisk.y =
                    toPeg.y +
                    toPeg.h -
                    (workingDisk.h + 0.1) * (disksUnder + 1);
            }
        );
